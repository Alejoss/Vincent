...
**GHA:** la ingesta programada es `.github/workflows/productivity-pipeline.yml` (`0 8,14,20 * * *`). Classify+Notion va en `productivity-classify-notion.yml` (tras completadas). Horarios: [overview](overview.md).
