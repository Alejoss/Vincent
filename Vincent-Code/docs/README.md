...
Diagrama y rutina diaria: [workflows/overview.md](workflows/overview.md). En GHA el ciclo corre 3×/día a las **8, 14 y 20 UTC** (ingesta → completadas → classify+Notion → recordatorios, tras cada éxito).
