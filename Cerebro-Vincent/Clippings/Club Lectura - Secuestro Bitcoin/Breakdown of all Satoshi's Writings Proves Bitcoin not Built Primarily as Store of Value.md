...
source: "https://sampatt.com/blog/2019-06-06-satoshi-analysis/"
author:
published:
created: 2026-07-21
...
tags:
  - "clippings"
---
## El análisis detallado de todos los escritos de Satoshi demuestra que Bitcoin no fue creado principalmente como reserva de valor.

Un análisis basado en evidencia de los escritos de Satoshi Nakamoto que demuestra que Bitcoin no fue creado principalmente como una reserva de valor.

*TL;DR*

*Esta publicación fue escrita originalmente en junio de 2019.*

*La [afirmación de que](https://twitter.com/danheld/status/1084848064559337473) «Bitcoin fue diseñado inicialmente como reserva de valor» es falsa. Muchas de las declaraciones de Satoshi que se presentan como prueba de esta afirmación están sacadas de contexto. Al contextualizar dichas declaraciones y considerarlas junto con todos sus escritos, resulta innegable que Bitcoin no fue creado inicialmente como reserva de valor, sino para realizar pagos.*

## Resumen del video

![](https://www.youtube.com/watch?v=_j3ZrS5xirw)

## Actualizaciones

### 6 de junio de 2019

Se añadió una sección que analiza el comentario de Satoshi sobre el bloque génesis en la parte [de Evidencia de Depósito de Valor](#evidence-for-store-of-value).

## La pregunta

¿Satoshi creó Bitcoin principalmente como reserva de valor, o lo creó para realizar pagos?

Para responder a esta pregunta, acudí directamente a la fuente. Gracias a los [archivos](https://satoshi.nakamotoinstitute.org/) del Instituto Satoshi Nakamoto, pude leer absolutamente todo lo que Satoshi publicó públicamente: comentarios de 260 hilos de foros, 63 correos electrónicos y su código fuente original.

Tras revisar todos los escritos de Satoshi, puedo afirmar con seguridad que Bitcoin *no* fue creado inicialmente para ser una reserva de valor. Fue creado para pagos.

Esto no se basa en análisis de frecuencia de palabras ni en otras técnicas rudimentarias. Se basa en haber leído todas sus declaraciones *y* el contexto que las rodea.

No hace falta que me crean a mí. Esta publicación es tan larga porque voy a repasar *todas* las declaraciones de Satoshi relacionadas con el concepto de reserva de valor o pagos —en su contexto original— para que puedan comprobarlo ustedes mismos. Llevaré la cuenta de cuántas declaraciones hizo Satoshi en apoyo de la reserva de valor o los pagos (o ambos). Si prefieren no leer el artículo completo, pueden usar el índice para navegar por las secciones que les interesen.

Cuando el texto aparece en negrita entre comillas, es mi propio énfasis. No dudes en contactarme para añadir nuevas fuentes o cuestionar alguna de las que he publicado; actualizaré la entrada si presentas un buen argumento.

### Advertencias

Antes de entrar en las pruebas, tengo dos advertencias que hacer.

1. No estoy haciendo afirmaciones normativas, es decir, declaraciones del tipo «debería». Me centro exclusivamente en la afirmación histórica concreta de que Satoshi creó Bitcoin principalmente para que funcionara como reserva de valor. No se trata de lo que Bitcoin es hoy ni de lo que debería ser mañana, sino específicamente de la intención original de Satoshi, según sus propias palabras.
2. No creo que la opinión de Satoshi tenga tanta importancia hoy en día. Bitcoin puede ser lo que queramos que sea. Pero eso no significa que se deba dar vía libre a la gente para reescribir la historia y hacer afirmaciones falsas sobre las intenciones de Satoshi. Eso es intelectualmente deshonesto y hay que denunciarlo.

## Evidencia de depósito de valor

Está claro que Satoshi no era partidario de la banca central y que sabía que la política monetaria de Bitcoin le otorgaba propiedades únicas, pero el mero hecho de establecer esos datos no implica que Satoshi creara Bitcoin para que funcionara principalmente como reserva de valor.

Por lo que he podido averiguar, Satoshi nunca escribió las palabras «reserva de valor». Esto parecería plantear un problema para quienes defienden la idea de que Satoshi creó Bitcoin como una reserva de valor. Sin embargo, sí habló de ello indirectamente. Así pues, para darle al argumento la mejor oportunidad posible, examinemos cada ocasión en la que habló de algo que pudiera interpretarse como un apoyo a la idea de una reserva de valor, aunque sea una interpretación forzada.

Satoshi mencionó las propiedades de Bitcoin como reserva de valor un total de ocho veces en todos sus escritos. Las analizaré una por una a continuación.

Ocho menciones no son muchas, pero veamos el mejor argumento posible. Proviene de Dan Held, un ferviente defensor de la idea de que Bitcoin sea una reserva de valor, quien [afirma](https://twitter.com/danheld/status/1134405481177452544): «\[Bitcoin\] fue diseñado desde el primer día para ser un Oro 2.0».

A principios de este año, Dan publicó un [extenso hilo en Twitter](https://twitter.com/danheld/status/1084848063947071488) exponiendo sus argumentos. El hilo se hizo popular y se suele citar como una buena prueba de la afirmación de que el valor del depósito es una reserva de valor.

Publica 47 tuits, pero solo seis citan a Satoshi hablando directamente sobre el concepto de reserva de valor. Analizo algunos de sus otros tuits en la sección " [Otras afirmaciones"](#other-claims).

### Fuente n.° 1: Publicación de la Fundación P2P

La primera cita de Dan sobre Satoshi proviene de una [publicación de la Fundación P2P](https://satoshi.nakamotoinstitute.org/posts/p2pfoundation/1/):

> El problema fundamental de las monedas convencionales radica en la gran confianza que se requiere para que funcionen. Hay que confiar en que el banco central no devaluará la moneda, pero la historia de las monedas fiduciarias está plagada de casos en los que se ha roto esa confianza.

Eso suena a apoyo a Bitcoin como reserva de valor. Añadamos uno a la lista de reservas de valor:

| Caso de uso de BTC | Satoshi menciona |
| --- | --- |
| Depósito de valor | 1 |
| Pagos | 0 |
...
Esta cita es solo un fragmento de dos frases de una publicación extensa. Si lees la publicación completa, verás que Satoshi también apoya de forma inequívoca el uso de Bitcoin para pagos.

De hecho, en el mismo párrafo de la cita anterior, mencionó los micropagos:

> Los enormes costes generales de los bancos hacen imposibles los micropagos.

Y más adelante en el artículo se mencionaron los micropagos por segunda vez:
...
> Just having an open bitcoin server at [domain.com](http://domain.com/) that users could send unidentified payments to would be too much of a liability. **Regular users aren’t used to the idea of having to identify the payment. Merchants would get too many blank payments followed by “I paid you, where’s my stuff?!” a week later.**
...
> > You can of course use services like [vekja.net](http://vekja.net/) or [mybitcoin.com](http://mybitcoin.com/) on a mobile browser, depositing money there to the extent you trust them.
